...
const AchievementDetailPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-16 px-6 lg:px-8">
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="card-dark p-8">
        <div className="flex gap-2 mb-3">
          <span className="badge-gold">ACHIEVEMENT LEVEL</span>
          <span className="font-mono text-2xs text-yellow-200 mt-1">ID: {id}</span>
        </div>
        <h1 className="font-display text-4xl text-yellow-400 uppercase mb-4">Achievement Record</h1>
        <div className="flex flex-col md:flex-row gap-8 mt-8">
          <div className="flex-1 text-yellow-200 text-lg leading-relaxed">
            ...
            <div className="bg-olive/5 p-6 rounded-sm border border-olive/10 mt-6 flex items-center justify-center">
              <span className="text-yellow-200 font-mono text-sm">[ Certificate / Medal Image Placeholder ]</span>
            </div>
          </div>
