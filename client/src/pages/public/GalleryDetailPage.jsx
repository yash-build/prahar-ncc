...
const GalleryDetailPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-16 px-6 lg:px-8">
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="card-dark overflow-hidden">
        <div className="h-96 bg-olive-dark/10 flex items-center justify-center relative">
          <span className="font-display text-6xl text-yellow-400/20 uppercase tracking-widest">NCC MEDIA</span>
        </div>
        <div className="p-8">
          ...
          <h1 className="font-display text-4xl text-yellow-400 uppercase mb-4">Gallery Event Record</h1>
